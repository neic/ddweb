...
urlpatterns = [
    ...
    url(r"^news/", include("ddweb.apps.news.urls"), name="news"),
    url(
        r"^contact/", TemplateView.as_view(template_name="contact.html"), name="contact"
    ),
    url(r"^references/", include("ddweb.apps.references.urls"), name="references"),
    url(r"^images/", include("ddweb.apps.images.urls"), name="images"),
